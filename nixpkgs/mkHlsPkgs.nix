  ...
  hlsPkgs = import ./hls.nix {
    ...
    config = {
      ...
      haskell-nix.hackage.sha256map = {
        "https://github.com/bubba/brittany"."c59655f10d5ad295c2481537fc8abf0a297d9d1c" = "1rkk09f8750qykrmkqfqbh44dbx1p8aq1caznxxlw8zqfvx39cxl";
        "https://github.com/bubba/hie-bios"."cec139a1c3da1632d9a59271acc70156413017e7" = "1iqk55jga4naghmh8zak9q7ssxawk820vw8932dhympb767dfkha";
      };
